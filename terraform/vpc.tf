...
# ── Public Subnets ────────────────────────────────────────────
# EKS Load Balancers live here
# Nginx ingress will be accessible from here
resource "aws_subnet" "public" {
  ...
  tags = {
    ...
    Tier = "public"
    # Required for EKS to discover public subnets for LB
    "kubernetes.io/cluster/${var.project_name}-eks" = "shared"
...
# ── NAT Gateway ───────────────────────────────────────────────
# Allows private subnet nodes to reach internet
